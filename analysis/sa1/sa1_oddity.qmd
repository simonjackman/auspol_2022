...
The AEC has produced a [file](https://www.aec.gov.au/Elections/Federal_Elections/2022/files/downloads/2022-federal-election-votes-sa1.csv "AEC SA1 vote statistics") that provides House of Representatives voter turnout counts from the 2022 election at each of the polling places utilised by the voters residing in small geographic areas.  The file is routinely produced after each election and is often referred to as the polling place "catchment file", since it helps analysts and the AEC itself identify the geographic areas serviced by polling places (the "catchment" area of each polling place). 
...
d_01_16 <- read_csv(
  file = here("data/2022/SA1/2016_GCP_SA1_for_AUS_short-header/2016 Census GCP Statistical Area 1 for AUST/2016Census_G01_AUS_SA1.csv")
  ) %>% 
