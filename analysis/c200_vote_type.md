...
```{.js .cell-code .hidden startFrom="276" source-offset="-0"}
...
```{.js .cell-code .hidden startFrom="285" source-offset="-0"}
...
```{.js .cell-code .hidden startFrom="463" source-offset="0"}
Plot.plot({
  grid: false,
  width: 1020,
  height: 680,
...
```{=html}
<div id="tbl-vote-shares-by-type-2022-perf" style="width:100%;height:auto;" class="datatables html-widget"></div>
...
```{.js .cell-code .hidden startFrom="1364" source-offset="0"}
pd = transpose(pd_raw)
```
...
```{.js .cell-code .hidden startFrom="1371" source-offset="0"}
Plot.plot({
  grid: true,
  width: 1000,
  height: 1000,
...
```{=html}
<div id="tab-postal-independents" style="width:100%;height:auto;" class="datatables html-widget"></div>
...
```{.js .cell-code .hidden startFrom="1758" source-offset="0"}
...
```{.js .cell-code .hidden startFrom="1764" source-offset="0"}
Plot.plot({
  grid: true,
  width: 1000,
  height: 1000,
