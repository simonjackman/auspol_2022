...
The AEC has produced a [file](https://www.aec.gov.au/Elections/Federal_Elections/2022/files/downloads/2022-federal-election-votes-sa1.csv "AEC SA1 vote statistics") that provides House of Representatives voter turnout counts from the 2022 election at each of the polling places utilised by the voters residing in small geographic areas.  The file is routinely produced after each election, sometimes known as the "catchment file", since it helps analysts and the AEC itself identify the geographic areas serviced by polling places (the "catchment" area of each polling place). 
